...
public class Ex9Argument {
	...
	public static void main(String[] args) {
		...
		/*
		 * 이상욱 삼성전자 홍보부 89 100 74
		 * 
		 * 이름(name), 회사명(emp), 부서 (dep), 3 과목의 입사시험점수 (score1,score2,score3) 를 읽어서 위의
		 * 데이타와 입사시험의 총합계(total)과 평균(average)-소숫점 첫째자리까지만 출력(printf로 출력) 를 출력하시오
		 * 
		 */
		String name = args[0];
		String emp = args[1];
