...
public class Ex2ShopTable extends JFrame {
	...
	public Ex2ShopTable() {
		...
		this.initDesign();
		this.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);//x 클릭 시 종료
	...
	public void initDesign() {
		...
		//frame 중간에 table 넣기
		String []title= {"인덱스","상품명","수량","단가","입고일","총금액"};
		...
		btnDel.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				int idx=Integer.parseInt((String)table.getValueAt(row, 0));//방법 2
				//삭제 메서드 호출
