...
public class Ex11Exam {
	...
	public static void main(String[] args) {
		...
		/*
		 * 년(year),월(month),일(day) 를 입력후 해당날짜에 대한 Date 클래스를 생성후(myDate) myDate 를 이용해서
		 * 년도,월,일,요일(week)을 구해서 출력하시오 요일은 요일숫자(weekNum)를 먼저 얻은후 요일을 구해서 출력
		 * 
		 */
		...
		System.out.println((weekNum == 0 ? "일"
				: weekNum == 1 ? "월"
						: weekNum == 2 ? "화" : weekNum == 3 ? "수" : weekNum == 4 ? "목" : weekNum == 5 ? "금" : "토")
				+ "요일입니다");
	}
