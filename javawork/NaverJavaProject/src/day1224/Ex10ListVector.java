...
public class Ex10ListVector {
	...
	public static void main(String[] args) {
		...
		List<String> list2=new Vector<String>(5,3);//기본 5개가 할당, 3개씩 증가

		System.out.println("list1 의 데이터 갯수는 "+list1.size()+",할당갯수:"
				+((Vector<String>)list1).capacity());//capacity() 메소드는 오버라이드 메소드가 아님
		System.out.println("list2 의 데이터 갯수는 "+list2.size()+",할당갯수:"
				+((Vector<String>)list2).capacity());//capacity() 메소드는 오버라이드 메소드가 아님
