     				...
     				$.each(res,function(i,item){    					
     					s+=`
     						...
     						<span class="remod" style="margin-left:20px;">
     							<a href="#" style="color:gray;">수정</a>
     						</span>
     						<span class="redel" style="margin-left:5spx;">
     							<a href="#" style="color:gray;" num="\${item.num}">삭제</a>
     						</span>
...
<div style="margin: 30px;width: 600px;">
	...
	<div style="marker-offset: 30px;width:500px;border: 1px solid gray;">
		<b>${writer}</b><br>
		...
		<script type="text/javascript">
			...
			$(document).on("click",".replephotodel",function(){
				...
				$.ajax({
					...
					url:"./replephotodel",
					success:function(){
						close.prev().remove();//x 아이콘 바로 앞의 사진삭제
						close.remove(); // x 아이콘 삭제
					}
				});
			});
	...
	<div style="margin-top: 30px;">
		...
		<c:if test="${sessionScope.loginid == dto.myid}">
			...
			<script type="text/javascript">
				function boarddel() {
					//삭제할지 물어보고 확인 누르면 삭제 후 목록으로 이동(페이지 번호 전달)
