			...
			<tbody>
				<tr>
					...
					<td>
						...
						required="required" class="form-control" value="${dto.sangpum}"> 
					</td>
				</tr>
				<tr>
					<th>가격</th>
					<td>
						...
						required="required" class="form-control" step="5000" min="0"> 
					</td>
				</tr>
				<tr>
					<th>수량</th>
				...
				<tr>
					<th>색상</th>
					<td>
						<input type="color" name="scolor" value="${dto.scolor}"
						class="form-control"> 
					</td>
				</tr>
				<tr>
					<th>입고일</th>
					<td>
						<input type="date" name="ipgoday" value="${dto.ipgoday}"
						class="form-control"> 
					</td>
				</tr>
				<tr>
