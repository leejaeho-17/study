		...
		<table class="tab table table-bordered" style="width: 400px;">
			...
			<tr>
				...
				<td>
					...
					autofocus="autofocus" name="sname" value="<%=dto.getSname()%>">
				</td>
			</tr>
			<tr>
				<th width="100">사진</th>
				<td class="input-group">
					...
					%>
						<option value="<%=s%>"
						<%=s.equals(dto.getSphoto())? "selected" : "" %>>사진 #<%=i%>
						</option>
					<%}
					%>
					</select>
			...
			<tr>
				...
				<td>
					...
					max="2025" class="form-control" required="required" value="<%=dto.getSbirth()%>">
				</td>
			</tr>
			<tr>
				<th width="100">혈액형</th>
				...
				<%
					...
					{%> 
						<label>
							<input type="radio" value="<%=b%>" name="sblood"
