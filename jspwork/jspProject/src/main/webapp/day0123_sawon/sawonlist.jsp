...
<%
	//검색단어 search 읽기
	//sawonlist.jsp 를 직접 실행시에는 search 라는 name 값이 안넘어온다
...
<div style="margin:30px;">
	<table class="tab table table-bordered" style="width:470px">
		 <caption align="top">
		 	<b>[사원목록(<%=list.size()%>명)]</b>
		 	
		 	<button type="button" class="btn btn-sm btn-success"
		 	style="float: right;" onclick="location.href='./sawonform.jsp'">사원등록</button>
		</caption>
		<tr>
			<td colspan="4">
