		...
		<table>
			<tr>
				...
				<td valign="middle">
					...
					<h5>색 상 : <div style="display: inline-block;background-color: ${dto.scolor}">${dto.scolor}</div></h5>
					<h5>수 량 : ${dto.scnt}개</h5>
					<h5>가 격 : 
						<fmt:formatNumber value="${dto.sprice }" type="currency"
