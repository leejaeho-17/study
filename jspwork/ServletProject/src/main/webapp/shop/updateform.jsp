	...
	<form action="./update" method="post">
		...
		<table class="table table-bordered">
			...
			<tr>
				...
				<td>
					<input type="text" name="sprice" id="sprice" value="${dto.sprice }"
					  class="form-control">
				</td>
			</tr>
			<tr>
				...
				<td>
					<input type="number" name="scnt" id="scnt" 
					  class="form-control" min="1" max="10" value="${dto.scnt }">
				</td>
			</tr>
			<tr>
				...
				<td>
					<input type="date" name="ipgoday" id="ipgoday" 
					  class="form-control" value="${dto.ipgoday}">
				</td>
			</tr>
			<tr>
				<td colspan="2" align="center">
					<button type="submit" style=width:120px;"
					class="btn btn-sm btn-success">상품수정</button>
					
					<button type="button" style=width:120px;"
					class="btn btn-sm btn-success" onclick="history.back()">이전으로</button>
				</td>
			</tr>			
		</table>
	</form>
